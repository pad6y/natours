...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFkNnkiLCJhIjoiY2theWNmZXF6MDJpdjMzcGppMnd3NnVkYSJ9.NPepW9fE1QSTqH6QoDQC2w';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bounds to include the current locations
...
if (mapBox) {
  ...
  (0, _mapbox.displayMap)(locations); // console.log(locations);
}
